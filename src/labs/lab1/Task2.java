package Tasks.lab1;//Напишите программу, которая анализирует список действий
// пользователя с кнопками "Like" и "Dislike" на YouTube и возвращает конечное состояние
// в виде одного из трех возможных результатов: "Dislike", "Like" или "Nothing",
// если ни одно действие не было совершено или последнее действие было отменено.
